...
#Region "Commomn Define"
    ...
    Event E_WorkSlipClick(SlipType As String)
...
#End Region
    ...
    Public Delegate Sub Update_dgvProductionInfo1Delegate3(ByVal _CarrierID As String, LotNo As String, ByVal Count As String, ByVal ByValREMARK As String)
    Public Sub Update_dgvProductionInfoEnd(ByVal _CarrierID As String, LotNo As String, ByVal Count As String, Optional ByVal REMARK As String = "")
        If Me.InvokeRequired Then
    ...
    Private Sub ProductionTable_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If My.Settings.DCSlip Then
            ...
            btnWorkSlip.Text = "DCSlip"
        Else
            btnWorkSlip.Text = "WorkSlip"
        End If
    ...
    Private Sub QRWorkSlipClick()     '170116 \783 Revise QR Work
        ...
        RaiseEvent E_WorkSlipClick(btnWorkSlip.Text)
        RaiseEvent E_SlInfo("Please Read " & btnWorkSlip.Text & " QR Data")
    End Sub
    ...
    Private Sub tbxKey_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles tbxKey.KeyPress, TextBox1.KeyPress
        If e.KeyChar = Convert.ToChar(13) Then
            If tbxKey.Text.Length = 252 Or tbxKey.Text.Length = My.Settings.WorkingSlipQRLenght Then              '160629 \783 Support New QR
                ...
                If My.Settings.DCSlip Then
                    RaiseEvent E_SlInfo("Error Type Slip")
                Else
            ...
            ElseIf tbxKey.Text.Length = 276 Then           '--------------------- DC Slip
                If My.Settings.DCSlip Then
                    OprData.QrData = tbxKey.Text.ToUpper
                    tbxKey.Text = ""
                    RaiseEvent E_QRReadSuccess()
            ...
            Else
                ...
                RaiseEvent E_SlInfo("QR Slip Read False QR Length : " & tbxKey.Text.Length)
