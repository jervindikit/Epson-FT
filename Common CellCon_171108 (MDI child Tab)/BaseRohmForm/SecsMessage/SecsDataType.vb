...
Public Class SecsDataType
    ...
    Public RPTID As New List(Of UInt16)      'U4=UInt32, U2=UInt16   Software support only 2 Type
    Public VID As New List(Of UInt16)        'U4=UInt32, U2=UInt16   Software support only 2 Type
    Public CEID As UInt16                    'U4=UInt32, U2=UInt16   Software support only 2 Type
    Public DATAID As U4_1 = U4_1.U2
    ...
    Public ECID As U4_1 = U4_1.U2                   'U4=UInt32, U2=UInt16   Software support only 2 Type 
    '>>Used by: S2F13 S2F15 S2F29 S2F30



    Public Enum U4_1            'U4:1 Format
        U1
        U2
        U4
    End Enum
