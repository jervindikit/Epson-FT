...
Public Class S2F15
    ...
    Public Sub AddListEcid(ByVal ecid As UInteger, ByVal ecv As String, ByVal Format As SecsFormat) '160823 \783 Addition SecsFormat
        ...
        Try
            ...
            If Type.ECID = SecsDataType.U4_1.U1 Then    '161222 \783 Config SECSGEM
                Dim ecidItem As SecsItemU1 = New SecsItemU1("ECID" & m_Ln.Value.Count.ToString(), CByte(ecid))
                l2.AddItem(ecidItem)
            ElseIf Type.ECID = SecsDataType.U4_1.U2 Then    '161222 \783 Config SECSGEM
