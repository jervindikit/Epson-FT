...
#Region "Commomn Define"
    ...
    Friend NetVerSion As String = "+ Relaese Ver1.01_170727"
    '-----------------------------------------------------------------
...
#End Region
    ...
    Public Sub SaveCatchLog(ByVal message As String, ByVal fnName As String)
        FormMain.ToolStripLabelMessage.Text = "TryCatch Err Please check log" & Format(Now, " |HH:mm:ss.fff")   '170328 \783 information adddition if Catch Err
