...
#End Region
    ...
    Private Sub tbSetting_Selected(sender As Object, e As System.Windows.Forms.TabControlEventArgs) Handles tbSetting.Selected
        ...
        Select Case e.TabPage.Name
            ...
            Case "tbSecsGem"
                Dim mcList As New List(Of String)
                mcList = FormMain.GetInstance.MachineList()
                ComboBoxEquipmentIP.Items.AddRange(mcList.ToArray)
                ComboBoxEquipmentIP.SelectedIndex = 0
            ...
            Case "tbEventReport"   '170105 \783 \Config SECSGEM ID
                ...
                dgvCEID.Rows(0).Cells(1).Value = SecsID.LotStartCEID
                dgvCEID.Rows(1).Cells(1).Value = SecsID.LotEndCEID
    ...
    Private Sub AddUserToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles AddUserToolStripMenuItem.Click
        ...
        If User.CurrentUser Is Nothing Then
            MsgBox("Please login first")
        ElseIf User.CurrentUser.Level <> User.UserLevel.ADMIN Then
            MsgBox("The only admin level is allowed.")
            Exit Sub
        End If

        Using frm As New FormManageUser
            frm.ShowDialog()
        End Using
    End Sub
