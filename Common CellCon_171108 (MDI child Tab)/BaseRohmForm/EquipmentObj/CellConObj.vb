...
#Region "TDC Object ---------------"
    ...
    Private _TotalGoodPcs As Integer         'Total Good
    Public Property TotalGoodPcs() As Integer
        Get
    ...
    Private _TotalNGPcs As Integer           'Total Ng
    Public Property TotalNGPcs() As Integer
        Get
            Return _TotalNGPcs
        End Get
        Set(ByVal value As Integer)
