...
Public Class FormConsole
    ...
    '    RemoveHandler m_Controller.CurrentHsmsHost.TracedSmlLog, AddressOf ThreadSafe_SecsTracedLog
    'End Sub

    'Private Sub FormConsole_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
    '    AddHandler m_Controller.CurrentHsmsHost.TracedSmlLog, AddressOf ThreadSafe_SecsTracedLog
